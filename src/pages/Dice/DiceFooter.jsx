            ...
            <div className="flex justify-between items-center">
              <div className="pl-4">
                ...
                <div className="relative flex items-center h-6 w-32 bg-[#08565A] rounded-3xl border-black border-[0.5px]">
                  <span className="text-white text-xs pl-2 pr-1 absolute left-1">
                    ₹
                  </span>
                  <input
                    inputMode="numeric"
                    ...
                    className="pl-6 pr-2 bg-transparent flex-1 text-white text-xs text-left outline-none placeholder:text-[10px] no-spinner"
                  />
                </div>
              </div>
