...
function JhandiMundaFooter({ shuffling, betAmount, setBetAmount, onPlaceBet, timeLeft }) {
                ...
                <div className="flex items-center h-6 w-32 bg-[#666666] rounded-3xl border-black border-[0.5px] px-2">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      // Allow only integers and prevent value > wallet
...
export default JhandiMundaFooter;
