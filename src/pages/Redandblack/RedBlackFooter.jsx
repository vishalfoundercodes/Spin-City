...
function RedBlackFooter({ betAmount, setBetAmount, onPlaceBet, timeLeft }) {
  ...
  return (
    <div className="relative">
      <div className='flex items-center justify-center p-2 mt-0 xsm:mt-2'>
        <div className='sm:h-36 w-full rounded-lg bg-[#CC0000] px-4 py-1 xsm:p-4'>
  ...
  <input
    ...
    onChange={(e) => {
      ...
      // Allow only integers and prevent exceeding wallet
  ...
  />
          ...
          <div className='flex items-center justify-between'>
            <button
              ...
              onClick={onPlaceBet}
              className={`relative ${(timeLeft > 0 && timeLeft < 13) ? "bg-gray" : "bg-gradient-to-tr from-[#448B02] to-[#5FAF09]"} text-white shadow-lg drop-shadow-[0_4px_3px_rgba(0,0,0,0.3)] h-8 xs1:h-12 w-full font-serif font-bold text-[14px] m-1 xs1:m-3 rounded-2xl flex items-center justify-center`}>
              BET
            </button>
          </div>
